...
export default function StudentKioskScreen() {
  ...
  useEffect(() => {
    if (
      ...
      verification.text.includes("payment") &&
      studentIdInput &&
      ...
      <View style={styles.header}>
        <View style={styles.headerTitleContainer}>
          ...
          <Text style={styles.headerTitle}>
            {sysConfig.textCustoms["lbl-terminal-title"]}
          </Text>
        </View>
        <TouchableOpacity
      ...
      <ScrollView contentContainerStyle={styles.main}>
        <View style={styles.section}>
          <Text style={styles.label}>
            Select Current Active Session Track Group
          </Text>
          ...
          <View style={styles.statusRow}>
            <View style={styles.statusItem}>
              ...
              <Text
                style={[
                  styles.statusValue,
                  !activeCourseObj && styles.statusValueEmpty,
                ]}
              >
                {activeCourseObj ? (
                  <Text>
        ...
        <View style={styles.inputSection}>
          ...
          <View
            style={[
              styles.idDisplay,
              !activeCourseObj && styles.idDisplayDisabled,
            ]}
          >
            <Text
              style={[
                styles.idDisplayText,
                !studentIdInput && styles.idPlaceholder,
              ]}
            >
          ...
          <View style={styles.keypadContainer}>
            ...
            <View style={styles.keypadRow}>
              <Key
                value="Clear"
                isAction
                onPress={() => setStudentIdInput("")}
              />
              <Key value="0" onPress={() => handleKeyPress("0")} />
              <Key
                value={<Delete size={24} color={Colors.secondary} />}
                isAction
