...
import { Users, Calendar, BarChart, Settings, Bell } from 'lucide-react-native';
...
const TabButton = ({ label, isFocused, onPress, icon: Icon, badgeCount }: any) => {
        ...
        options={{
          tabBarButton: (props) => (
            <TabButton
              ...
              label="Alerts"
              icon={Bell}
              badgeCount={paymentAlerts.length}
              isFocused={props.accessibilityState?.selected}
            />
          ),
        }}
